...
const FooterLink = ({
    ...
    const baseClasses = "tracking-tight text-base lg:text-[20px] lg:leading-[25px] font-jost text-text-" +
            "gray";
    ...
    return (
        <a
            ...
            <span className="relative group">
                {label}
                <span
                    className="absolute bottom-0 left-0 w-full h-0.5 bg-primary-200 transform scale-x-0
...
const FooterSection = ({
    ...
    <div className="col-span-1 flex flex-col gap-4">
        <span
            className="text-primary-200 font-dm text-[22px] lg:text-[20px] leading-loose">
            {
                isContact
                    ? (
                        <a
...
const Footer = () => {
    return (
        <footer className="mt-[135px] w-full" aria-label="Stopka">
            <div
                className="w-full max-w-[1200px] px-12 xl:px-0 mx-auto pb-[135px] grid grid-cols-1 lg:grid-cols-5 md:grid-cols-2 gap-6">
                <div className="col-span-1 md:col-span-2">
                    ...
                    <p
                        className="tracking-tight text-base lg:text-[20px] lg:leading-[25px] font-jost text-text-gray pt-[18px] pb-[33px]">
