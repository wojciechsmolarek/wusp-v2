...
const ContactInfo = () => {
    return (
        <div
            className="w-full max-w-[480px] mx-auto bg-primary-300 rounded-[36px] shadow-lg px-6 py-10 sm:px-8 sm:py-12 flex flex-col gap-8">
            <div className="mb-2 flex flex-col items-center">
                <h2
                    className="text-[28px] font-dm text-primary-200 text-center tracking-wide leading-tight">
                    Dane kontaktowe
                </h2>
            </div>
            <div className="flex flex-col gap-7">
                <div
                    className="flex flex-col gap-1 text-lg font-jost tracking-tight text-text-gray-200">
