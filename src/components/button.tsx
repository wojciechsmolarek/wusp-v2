...
const Button = (props: ButtonProps) => {
  ...
  const defaultStyles =
    "rounded-[18px] flex items-center justify-center gap-[9px] w-fit text-base lg:text-lg font-semibold leading-snug tracking-tight px-10 py-5 md:px-[54px] md:py-[26px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-colors duration-300";
  
  let bgClass = "";
  let textColor = "text-white";
  let arrowComponent = variant === "primary" ? <ArrowSec /> : <ArrowPri />;
  let outlineClass = "";
